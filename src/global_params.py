...
class System_Config_Params(BaseParams):
    def __init__(self,app_name,module_name):
        ...
        self.buffer_size_calculate_focus : int = 50
        self.kernel_blur_size_calculate_focus : Union[list[int],tuple[int,int],None] = None
...
class Camera_Config_Params(BaseParams):
    def __init__(self,app_name : str,module_name : str):
        ...
        self.ratio_pixel_to_um : float = 0.2 # 2.5 um/pixel
...
class Timer_Config(BaseParams):
    def __init__(self,app_name : str,module_name : str):
        super().__init__(app_name, module_name)
        self.day_start_time : list[int] = [7,30]
        self.day_end_time : list[int] = [19,30]
        self.create_or_load_yaml()
...
timer_config_params = Timer_Config(app_name=APP_NAME,module_name='Timer_Config')
...
def save_all_config():
    ...
    timer_config_params.save_to_config_file()
